                                ...
                                <>
                                    ...
                                    <div className=''>
                                        ...
                                        <div className='mt-[20px]  flex justify-evenly'>
                                            ...
                                            <div className='border-2 border-zinc-900  pl-[10px] pr-[10px]'>
                                                <p>Seat</p>
                                                <h2 className='font-bold'>15B</h2>
                                            </div>
                                        </div>

                                        <div className='flex justify-between'>
                                            <div className='mt-[50px] ml-[30px] mb-[40px]'>
                                                <QRCode value="https://flight-bag-tag-generator.vercel.app/madhu/form2" size="140" renderAs="canvas" />
                                            </div>
                                ...
                                <div className=''>
                                    ...
                                    <div>
                                        <div className='flex justify-between m-[20px]'>
                                            <p>PNR</p>
                                            <p className='font-bold'>QDRC9N</p>
                                        </div>
                                    ...
                                    <div className='flex justify-between'>
                                        <div className='mt-[10px] ml-[20px] mb-[40px]'>
                                            <QRCode value="https://flight-bag-tag-generator.vercel.app/madhu/form2" size="100" renderAs="canvas" />
                                        </div>
...
export default BoardingPassMadhu